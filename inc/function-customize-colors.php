...
@package bureau theme
	...
	footer background and main menu.
*/
function bureau_customize_register( $wp_customize ){

/*
	Add settings to header background, footer background and main menu color controls
*/
...
/*
	Add controls to header background, footer background and main menu color controls
*/
